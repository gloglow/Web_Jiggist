export default function SignUp() {
  return (
    <body className="max-w-7xl mx-auto w-full px-6 md:px-16 py-10">
      <div className="flex flex-col gap-6 mb-12">
      <nav className="flex items-center gap-2 text-sm text-slate-500">
        <a className="hover:text-primary transition-colors" href="#">Home</a>
        <span className="material-symbols-outlined text-xs">chevron_right</span>
        <span className="text-slate-300">Sign Up</span>
      </nav>
      </div>
        ...
        <div className="w-full max-w-md">
          <div className="bg-neutral-dark border border-border-muted p-10 rounded-xl shadow-2xl">
            <div className="text-center mb-10">
              <h1 className="text-4xl font-light text-slate-100 mb-3 tracking-wide">Welcome Back</h1>
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-neutral-dark px-4 text-slate-500 font-bold tracking-widest">Or continue with</span>
              </div>
            </div>
            ...
            <p className="text-center mt-8 text-xs text-slate-500 font-medium">
              New to the club? <a className="text-primary hover:underline font-bold" href="#">Request Invite</a>
            </p>
          </div>
        </div>
      </main>
